    ...
    return (
        <>
            ...
            <div className='w-screen h-96 bg-fixed bg-left bg-top md:bg-center' 
                 style={{backgroundImage: "url( "+ "/images/pipe-flange.jpg" +" )"}}>
            </div>
            
            <div className='px-5 text-center mt-12 mb-12 lg:flex lg:container lg:mx-auto'>
                ...
                <div className='md:w-1/3'>
                    ...
                    <div className='pt-6' >
                        ...
                        <ul className='list-disc inside-list pt-3'>
                            <li>Controlling Your Pump System</li>
                            <li>Optiflow Multi-pump Control</li>
                            <li>Pump Staging Cascade Control</li>
                            <li>Optimising Efficiency</li>
                            <li>Hand / Auto</li>
                            <li>Avoid Pump Downtime</li>
                            <li>Blockage detect/clear</li>
